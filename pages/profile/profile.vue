	...
	<view class="user">
		...
		>
			...
			<view class="promotion-center">
				...
				<view class="u-m-t-20">
					<u-cell-group>
						<u-cell-item :iconStyle="{color:'#3f80de'}" @click="clear()" icon="setting-fill" title="退出登录"></u-cell-item>
						
						<u-cell-item :iconStyle="{color:'#3f80de'}" @click="tologin" icon="man-add-fill" title="前往登录"></u-cell-item>
					</u-cell-group>
				</view>
...
export default {
	...
	data() {
		return {
			...
			title: '个人中心',
			settingList: [{
				title:"我的订单",url:"/pages/pet/order"},{
				title:"个人信息"},
				{title:"宠物信息",url:"/pages/pet/petInfo"},
				{title:"社区",url:"/pages/pet/petInfo"}
			],
